...
I recently created a reuseable django app and was wondering how I'd go about testing it without creating an entire django application.
Lucky for us, django has got an [example](https://docs.djangoproject.com/en/4.2/topics/testing/advanced/#testing-reusable-applications) for how to go about it.
...
* Create a `tests` package outside the `work` directory.
* Move the `work/tests.py` file to the `tests` directory.
* Create a file called `runtests.py` at the top level, outside of the `work` app. This file will be used to run the tests.
...
## Github Action
If you use github, you can use [github actions](https://docs.github.com/en/actions/learn-github-actions/understanding-github-actions) to run tests everytime you push to your master branch. Lets create a github action for our `work` app.

* Create a directory `.github/workflows/`
* Create a file called `work.yml` and place it in the `workflows` directory.
